...
function Movies() {
    ...
    useEffect(() => {
        async function getAllData() {
            Promise.all([
                ...
                .then(([movie, topMovies, topSeries, popularSeries, popularPerson, MovieChanges]) => {
                    setMovie(movie)
                    setTopMovies(topMovies)
                    setTopSeries(topSeries)
                    setPopularSeries(popularSeries)
                    setPopularPerson(popularPerson)
                    setMovieChanges(MovieChanges)
                })
    ...
    return (<>
        ...
        {MovieChanges && <Slider info={MovieChanges} title={'Lista de Filmes'} />}
